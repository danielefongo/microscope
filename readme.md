...
Another utility function is `microscope.utils.highlight` (this is **DEPRECATED** in favor of [treesitter](#treesitter)). This function accepts a `path` and a `bufnr` and automatically highlights the buffer based on the inferred filetype.
